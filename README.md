...
[NEC](https://www.sbprojects.net/knowledge/ir/nec.php), [RC5](https://www.sbprojects.net/knowledge/ir/rc5.php) and [SAMSUNG](http://techiesms.blogspot.com/2016/01/ir-protocol-decoding-and-transmiting.html) have different encoding rules, but all can be compatible to RMT data format.
