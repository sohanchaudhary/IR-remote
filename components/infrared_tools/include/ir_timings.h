...
#define SHARP_PAYLOAD_ONE_HIGH_US (320)
#define SHARP_PAYLOAD_ONE_LOW_US (1680)
#define SHARP_PAYLOAD_ZERO_HIGH_US (320)
#define SHARP_PAYLOAD_ZERO_LOW_US (680)
#define SHARP_REPEAT_CODE_HIGH_US (320)
#define SHARP_REPEAT_CODE_LOW_US (3000)
#define SHARP_DELAY_LOW_US (40000)
#define SHARP_ENDING_CODE_HIGH_US (320)
