...
/**
* @brief Creat a SAMSUNG protocol builder
*
* @param config: configuration of SAMSUNG builder
* @return
*      Handle of SAMSUNG builder or NULL
*/
...
/**
* @brief Creat a SAMSUNG protocol parser
*
* @param config: configuration of SAMSUNG parser
* @return
