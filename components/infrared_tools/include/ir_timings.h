...
/**
 * @brief Timings for SHARP protocol
 *
 */

#define SHARP_PAYLOAD_ONE_HIGH_US (260)
#define SHARP_PAYLOAD_ONE_LOW_US (1820)
#define SHARP_PAYLOAD_ZERO_HIGH_US (260)
#define SHARP_PAYLOAD_ZERO_LOW_US (780)
#define SHARP_REPEAT_CODE_HIGH_US (260)
#define SHARP_REPEAT_CODE_LOW_US (3000)
#define SHARP_DELAY_LOW_US (45000)
#define SHARP_ENDING_CODE_HIGH_US (260)
